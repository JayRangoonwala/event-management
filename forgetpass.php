...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "update `registration` set password = '$password' where username='$username'";
        ...
        <main>
            <section>
                ...
                <form action="forgetpass.php" method="post">
                    ...
                    <input type="password" id="password" name="cpassword" placeholder="Enter Password" required>
                    <p class="form-footer">Don't Have an Account? <a href="register1.php"><strong>Register</strong></a></p>
                    
                    <?php 
            if($invalid){
                echo "<p class='alert'>Not Matching Password and Confirm Password !!<p>";
            }
        ?>
