    ...
    <div class="background">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="event-details.html">All Events</a></li>
        ...
        <div class="content">
            ...
            <p><strong>Description:</strong> <?php echo nl2br($event['description']); ?></p><br><br>
            <p><strong> ATTENDEES OF EVENT </strong></p>
            <?php
                include 'connect.php';
                $event_id = $_GET['event_id'];

                $sql = "SELECT * FROM `register` WHERE eventid = '$event_id'";
                $result = mysqli_query($connect, $sql);
    
                if($result){
                    $count = 0;
                    while($event1 = mysqli_fetch_assoc($result)){
                        echo $event1['attendees']."<br>";
                        $count += 1;
                    }
